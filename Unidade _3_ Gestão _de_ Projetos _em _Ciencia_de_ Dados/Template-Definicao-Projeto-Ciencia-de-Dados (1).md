...
|---|---|---|---|
| Isabella Ana Dutra de Sousa | Documentação (Casos de Uso / Dados e IA) | Elaborar e manter a documentação dos casos de uso do sistema; documentar aspectos relacionados a dados e IA (fontes de dados, modelos utilizados, fluxo de dados) | Acesso aos requisitos do projeto e alinhamento com quem desenvolve a parte de dados/IA para documentar corretamente |
| Jhonathan de Moura Santos | Desenvolvimento Front-end e Back-end | Implementar as telas e a lógica de interface (front-end); desenvolver a lógica de negócio, APIs e integrações no servidor (back-end) | Definição clara dos requisitos funcionais e acesso ao ambiente de desenvolvimento/infraestrutura |
